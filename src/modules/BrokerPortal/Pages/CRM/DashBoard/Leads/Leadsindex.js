...
function Leadsindex() {
  ...
  const handleLinkProceed = (row) => {
    navigate(
      `/modules/BrokerPortal/Pages/CRM/DashBoard/Leads/Profileindex?ProspectID=${row}&Type=Lead`
    );
  };
  ...
  useEffect(async () => {
    await getRequest(`Lead/ViewDetails?ProspectID=&Type=Lead&status=`).then((response) => {
  ...
  useEffect(async () => {
    await getRequest(`Lead/CountForCRMProspects?ProspectType=leads`).then((res) => {
      setCountLead(res.data);
    });
  }, [newCrm]);
                ...
                >
                  <Grid container p={3}>
                    ...
                    <Grid item xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                      ...
                      >
                        Last month : {countLead.LastMonth} Leads
                      </MDTypography>
                    </Grid>
                  </Grid>
                </Card>
              ...
              <Grid item xs={12} sm={12} md={3} lg={3} xl={3} xxl={3}>
                ...
                >
                  <Grid container p={3}>
                    ...
                    <Grid item xs={12} sm={12} md={8} lg={8} xl={8} xxl={8}>
                      <MDTypography variant="h4" sx={{ ml: "-1rem" }}>
                        {countLead.leadsWithOpportunity}
                      </MDTypography>
                      <MDTypography
                        variant="h4"
                        sx={{ fontWeight: "400", fontSize: "13.5px", ml: "-1rem" }}
                      >
                        Leads with opportunities
                      </MDTypography>
                    </Grid>
                  </Grid>
                </Card>
