...
function Documentss({ crmData, setCrmData }) {
  ...
  //     setCRMData(dispatch, crmData);
  //
  //   });
  // }, [crmData]);
  // const [docUpload, sedocUpload] = useState(false);
  // const [masterSelection, setMasterSelection] = useState({
  //   Documents: { mID: "", mValue: "" },
  // });
  // console.log("masterSelection", masterSelection);
  const handleDocuments = (e, value) => {
    setTempDoc({ ...tempDoc, DocumentType: value.mValue });
  };
  //   const newValue = { ...masterSelection, Documents: value };
  //   setMasterSelection(newValue);
  //   if (value.mValue !== "") {
  //     crmData.ProspectDetailsJson.Documents[0].DocumentType = value.mValue;
