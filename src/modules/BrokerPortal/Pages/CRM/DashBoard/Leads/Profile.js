              ...
              <Stack justifyContent="left" direction="row" spacing={2}>
                ...
                <Grid item md={4.5}>
                  <MDDatePicker
                    ...
                    input={{
                      label: "Lead Created Date", // value: Crminfydto.CreatedDate,
              ...
              <>
                ...
                <Grid item md={3.7}>
                  <Autocomplete
                    ...
                    value={{ mValue: crmData.CommunicationDetails.Area }}
                    // value={Crminfydto.ProspectDetailsJson.CommunicationDetails.Area}
                    sx={{
                      "& .MuiOutlinedInput-root": {
                        padding: "5px!important",
                        fonstSize: "16px",
                ...
                <Grid item md={3.7}>
                  <Autocomplete
                    ...
                    options={Profession}
                    // value={Crminfydto.ProspectDetailsJson.Profession.mValue}
                    getOptionLabel={(option) => option.mValue}
                ...
                <Grid item md={4}>
                  <Autocomplete
                    ...
                    options={Source}
                    // value={Crminfydto.ProspectDetailsJson.Source}
                    value={{ mValue: crmData.Source }}
                    getOptionLabel={(option) => option.mValue}
                    renderInput={(params) => <MDInput {...params} label="Source" />}
                    error={crmData.Source === "" ? flags : null}
                ...
                <Grid item md={3.7}>
                  <Autocomplete
                    ...
                    options={Opportunities}
                    // value={Crminfydto.ProspectDetailsJson.Opportunity}
                    value={{ mValue: crmData.Opportunity }}
                    getOptionLabel={(option) => option.mValue}
                    renderInput={(params) => <MDInput {...params} label="Opportunities" />}
                    error={crmData.Opportunity === "" ? flags : null}
        ...
        <MDBox sx={style}>
          <Stack spacing={2}>
            ...
            <Grid container justifyContent="center">
              ...
              {/* <MDInput onChange={HandleNotes} onKeyDown={handleKeyDown} /> */}
              <TextareaAutosize
                minRows={5}
                style={{
                  width: "550px",
