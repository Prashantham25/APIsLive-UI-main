...
function Profile({ crmData, setCrmData }) {
  ...
  const handleSubmitAPI = async () => {
    await CreateCRM(crmData).then((res) => {
  ...
  const handleChangeDateCrm = (value) => {
    ...
    if (value !== null && isValid(new Date(value)) && dateString === 4) {
      ...
      if (age < 18) {
        ...
        setDate((prevState) => ({ ...prevState, dateOfBirth: null }));
        setCrmData((prevState) => ({ ...prevState, DateOfBirth: "" }));
      } else {
        setDate((prevState) => ({ ...prevState, dateOfBirth: value }));
        setCrmData((prevState) => ({ ...prevState, DateOfBirth: formatDate(value) }));
      }
    } else {
      setValidation((prevState) => ({ ...prevState, dateError: true }));
      setDate((prevState) => ({ ...prevState, dateOfBirth: null }));
        ...
        <MDBox fullWidth>
          <Grid container spacing={2.5}>
            <Grid item xs={12} sm={12} md={10} lg={10} xl={10} xxl={10}>
              <MDTypography sx={{ fontSize: "1.3rem", variant: "h3", fontWeight: 500, mr: "5rem" }}>
                Edit Profile
              </MDTypography>
            </Grid>
              ...
              <Stack justifyContent="left" direction="row" spacing={2}>
                ...
                <Grid item md={4.5}>
                  <MDDatePicker
                    disabled
                    input={{
                      label: "Client Created Date", // value: Crminfydto.CreatedDate,
            ...
            {individual === true && (
              <>
                ...
                <Grid item md={3.7}>
                  ...
                  <FormControl>
                    <RadioGroup
                      ...
                      onChange={handleChangeCrm}
                      // onChange={(event) => handleprofilegender(event)}
                      name="Gender"
                      sx={{ ml: "0.3rem" }}
                    >
                ...
                <Grid item md={3.7}>
                  ...
                  {validation.altMobileError && flags && crmData.AlternateMobileNumber !== "" ? (
                    <MDTypography sx={{ color: "red", fontSize: "10px" }}>
                ...
                value={crmData.DateOfBirth}
                onChange={(e, date) => handleDateChangeprofile(e, date)}
              /> */}
                  <LocalizationProvider dateAdapter={AdapterDateFns}>
                    <DesktopDatePicker
                      ...
                      onChange={(date) => handleChangeDateCrm(date)}
                      renderInput={(params) => (
                        <MDInput
                          {...params}
                          sx={{
              ...
              Object.values(crmData.CommunicationDetails.Area || {}).every(
                ...
                <Grid item md={3.7} sx={{ ml: "2rem" }}>
                  <Autocomplete
                    ...
                    options={Income}
                    // value={Crminfydto.ProspectDetailsJson.Income}
                ...
                <Grid item md={3.7} sx={{ ml: "2rem" }}>
                  <Autocomplete
                    ...
                    // onChange={handleAffordabilityStatus}
                    options={AffordabilityStatus}
                    // value={Crminfydto.ProspectDetailsJson.AffordabilityStatus}
            ...
            <Grid item xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
              <Stack direction="row" justifyContent="right">
                {/* {Submit === true && ( */}
                <MDButton onClick={handlesubmit} startIcon={<ArrowForwardIcon />}>
                  Submit
                </MDButton>
                {/* )} */}
              </Stack>
            ...
            >
              <MDBox sx={style}>
                <Stack spacing={2}>
                  ...
                  <Grid container justifyContent="center">
                    <MDButton color="info" variant="contained" onClick={handleProceed}>
                      Proceed
                    </MDButton>
                  </Grid>
                </Stack>
            ...
            <Grid item md={4}>
              <Stack justifyContent="flex-end" direction="row">
                <MDButton
                  startIcon={<EditIcon />}
                  onClick={drawfun1}
                  sx={{ ml: "4.8rem", mt: "1.5rem", borderRadius: "1px" }}
                >
                  Edit Profile
                </MDButton>
              </Stack>
          ...
          <>
            ...
            <Grid item md={3.5} sx={{ ml: "0.5rem" }}>
              <MDInput
                ...
                value={crmData.MobileNumber}
                // name="Mobile"
                sx={{ ml: "5rem", fonstSize: "16px", fontWeight: "400" }}
              />
            </Grid>
            {/* <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}> */}
            <Grid item md={3.5}>
