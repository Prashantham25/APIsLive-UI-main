...
function AddDocument({ handlemodalAddDocumentClose, handleclose }) {
  return (
    <MDBox sx={style}>
      <Grid container>
...
function Documentss({ crmData, setCrmData, setLoader }) {
  ...
  const handlemodalAddDocumentOpen = async () => {
    ...
    await postRequest(`Lead/CreateCRM`, {
      ...crmData,
      Documents: [...crmData.Documents, tempDoc],
    }).then(() => {
      setLoader(false);
          ...
          >
            <Grid container spacing={2} p={2}>
              ...
              <Grid item xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                ...
                <MDTypography
                  sx={{ display: "flex", flexDirection: "row", ml: "80px", fontSize: "12px" }}
                >
