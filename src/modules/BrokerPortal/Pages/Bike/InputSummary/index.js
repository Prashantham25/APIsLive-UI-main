...
import BikeQuote from "assets/images/BrokerPortal/BikeQuote.png";
...
import { GenerateQuickQuote } from "../BikeQuote/data/index";
...
function MotorQuotationInput({ handleClose, selected, quoteInput, handleModalClose }) {
  ...
  const onYearClick = (event) => {
    const newValue = { ...data, ManufactureYear: event.target.value };
  ...
  const onRegisClick = (value, label) => {
    const newValue = { ...data, [label]: formatDate(value) };
            ...
            <Grid container spacing={2} sx={{ mt: 2, px: 2 }}>
              ...
              <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <MDInput label="Bike Brand" {...params} variant="standard" />
                  )}
                />
              </Grid>
              <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
              ...
              <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
                <Autocomplete
                  ...
                  renderInput={(params) => (
                    <MDInput label="Bike Variant" {...params} variant="standard" />
                  )}
                />
              </Grid>
              <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
              ...
              <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
                <LocalizationProvider dateAdapter={AdapterDateFns}>
                  <DesktopDatePicker
                    ...
                    type="login"
                    id="RegistrationDate"
                    value={dateFormat(data.RegistrationDate)}
                    onChange={(date) => onRegisClick(date, "RegistrationDate")}
                    renderInput={(params) => (
                  ...
                  <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
                    <LocalizationProvider dateAdapter={AdapterDateFns}>
                      <DesktopDatePicker
                        ...
                        value={
                          data.PolicyType === "105" || data.PolicyType === "107"
                            ? dateFormat(data.ODPolicyEndDate)
                            : dateFormat(data.TPPolicyEndDate)
                        }
                        onChange={(date) =>
                          onDateChange(
                            date,
...
function calculateDate(date, offset) {
  const date1 = `${format(date.getDate())}-${format(date.getMonth() + 1)}-${
...
function InputSummary() {
  ...
  const [controller, dispatch] = useDataController();
  const { selected, fastLaneOutput, isNewBusiness, motorQuoteInput } = controller;
  ...
  const [quoteInput, setQuoteInput] = useState({
    ...
    PolicyEffectiveFromHour: "17:18:00",
    ...
    PreviousPolicyDetails: {
      ...
      previousPolicyExpiryDate: selected.ODPolicyEndDate,
      previousPolicyNumber: selected.PolicyNumber,
      isVehicleNew: "",
      PreviousPolicyEndDate:
        selected.PolicyType === "106" ? selected.TPPolicyEndDate : selected.ODPolicyEndDate,
      PreviousPolicyInsurerName: selected.InsuranceCompany,
      PreviousPolicyStartDate:
        selected.PolicyType === "106" ? selected.TPPolicyStartDate : selected.ODPolicyStartDate,
    ...
    PreviousTPPolicyDetails: {
      PreviousTPInsurerName: selected.InsuranceCompany,
    ...
    PreviousODPolicyDetails: {
      PreviousODInsurerName: selected.InsuranceCompany,
  ...
  // if (quoteInput === null) setQuoteInput(1);
  // const { quoteDetails } = GenerateQuickQuote().Masters;
  ...
  useEffect(() => {
    const newValue = isNewBusiness ? 5 : 1;
    ...
    <MDBox>
      ...
      <Grid container spacing={3} sx={{ px: "2rem", pt: "0.5rem", mt: -0.5 }}>
        ...
        <Grid item xs={12} sm={12} md={5} lg={5} xl={5} xxl={5}>
          <MDBox component="img" src={BikeQuote} sx={{ width: "100%" }} />
        </Grid>
          ...
          <Card sx={{ borderRadius: 0, background: "rgba(144, 202, 249, 0.2)", px: "2rem" }}>
            <MDBox>
              <MDTypography variant="h6" sx={{ mt: "3rem", fontSize: "1.5rem" }}>
                Please check your Bike details and proceed for plans
              </MDTypography>
                    ...
                    <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
                      <MDBox display="flex" flexDirection="column">
                        ...
                        <MDTypography variant="body1" sx={{ fontSize: "1rem" }}>
                          ...
                          {selected.PolicyType === "105" || selected.PolicyType === "107"
