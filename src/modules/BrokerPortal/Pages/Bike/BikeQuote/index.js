...
import Bike from "assets/images/BrokerPortal/BikeQuote.png";
...
function BikeQuote() {
  ...
  const [BusinessType, setBusinesstype] = useState("NewBusiness");
  ...
  const openBrand = (btype) => {
    ...
    motorQuoteInputJSON.TPTerm = btype === "4" ? "5" : "1";
    motorQuoteInputJSON.VehicleType = 17;
  ...
  useEffect(() => {
    localStorage.setItem("VehicleType", "TW");
  }, []);
  ...
  return (
    <MDBox>
      <BPNavbar />
      <MDBox sx={{ p: "2rem" }}>
        <MDBox display="flex" flexDirection="row" onClick={goBack} sx={{ mt: 2 }}>
        ...
        >
          <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
            <MDBox component="img" src={Bike} sx={{ width: "100%" }} />
          </Grid>
          <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
            <MDBox sx={{ ml: "3rem" }}>
              ...
              <Tooltip title="Click here to get quote">
