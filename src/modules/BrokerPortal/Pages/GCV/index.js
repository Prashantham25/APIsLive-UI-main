...
function GCVQuote() {
  ...
  // });
  // const OnNext = () => {
  //   navigate(`/modules/BrokerPortal/Pages/GCV/GCVInsureVehicle`);
  // };
  ...
  const openBrand = (btype) => {
    ...
    motorQuoteInputJSON.VehicleType = 193;
  ...
  useEffect(() => {
    localStorage.setItem("VehicleType", "GCV");
  }, []);
