...
function ApplicationList() {
  ...
  const handleCheckBox = (ApplicationNo, e) => {
    setChangeFlag(false);
    if (e.target.checked) setApplicationNumber([...ApplicationNumber, ApplicationNo]);
    else setApplicationNumber([...ApplicationNumber.filter((x) => x !== ApplicationNo)]);
                ...
                {appsNo1.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage).map((row) => (
                  ...
                  <TableRow>
                    ...
                    <Checkbox
                      ...
                      onChange={(e) => handleCheckBox(row.ApplicationNo, e)}
                      // value="POSP"
                    />
                    <TableCell
