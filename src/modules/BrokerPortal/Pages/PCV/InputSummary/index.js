    ...
    <MDBox>
      ...
      <Grid container spacing={3} sx={{ px: "2rem", pt: "0.5rem", mt: -0.5 }}>
        ...
        <Grid item xs={12} sm={12} md={5} lg={5} xl={5} xxl={5}>
          <MDBox component="img" src={PCVFrame} sx={{ width: "100%" }} />
          <MDBox component="img" src={PCVIP} sx={{ width: "80%", mt: "3rem", ml: "2rem" }} />
          <MDBox component="img" src={PCVBest} sx={{ width: "70%", ml: "4rem" }} />
        </Grid>
