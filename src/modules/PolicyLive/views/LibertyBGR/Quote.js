      ...
      await callPremiumMethod(policyArray).then((result) => {
        ...
        if (result.status === 1) {
          ...
          premiumStruc["Base Premium"] = Number(result.finalResult.BasePremium)
            .toFixed(2)
            .toString();
          premiumStruc["Terrorism Base"] = Number(result.finalResult.TerrorismPremium)
            .toFixed(2)
            .toString();
          premiumStruc["Add On (Premium)"] = Number(result.finalResult.TotalAddOnPremium)
            .toFixed(2)
            .toString();
          ...
          premiumStruc["Terrorism Premium"] = Number(
            result.finalResult.TerrorismPremium
          ...
          premiumStruc["Total Fire Premium"] = Number(result.finalResult.TotalFirePremium)
            .toFixed(2)
            .toString();
          premiumStruc["Total STFI Premium"] = Number(result.finalResult.STFIPremium)
            .toFixed(2)
            .toString();
          premiumStruc["Total EQ Premium"] = Number(result.finalResult.EQPremium)
            .toFixed(2)
            .toString();
          premiumStruc["Total Premium"] = Number(result.finalResult.TotalPolicyPremium)
            .toFixed(2)
            .toString();
          ...
          PremiumDetailforPDF.TotalPremium = Number(result.finalResult.TotalPolicyPremium)
            .toFixed(0)
            .toString();
  ...
  const handleCalculate = async () => {
    ...
    if (
      ...
      (polArray[valueTab]["Cover Type"] === "Home Building Only" &&
        (polArray[valueTab].InsurableItem[0].RiskItems[0]["Carpet Area (in sq. mts.)"] === "" ||
          polArray[valueTab].InsurableItem[0].RiskItems[0]["Cost of Construction"] === "")) ||
      (polArray[valueTab]["Cover Type"] === "Home Building & Home Contents" &&
        (polArray[valueTab].InsurableItem[0].RiskItems[0]["Carpet Area (in sq. mts.)"] === "" ||
          polArray[valueTab].InsurableItem[0].RiskItems[0]["Cost of Construction"] === "" ||
          polArray[valueTab].InsurableItem[0].RiskItems[0]["TotalCostofContents/SumInsured"] ===
            "")) ||
      ...
      //   "Rent for Alternative Accommodation(Months)"
      // ] === "" ||
      // polArray[valueTab].InsurableItem[0].RiskItems[0]["Loss Of Rent(Months)"] === "" ||
      // polArray[valueTab].InsurableItem[0].RiskItems[0][
      //   "Insured Members Covered under Individual PA?"
      // ] === "" ||
      // (polArray[valueTab].InsurableItem[0].RiskItems[0][
