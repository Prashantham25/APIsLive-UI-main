...
// import { Saveprofile, getMasterDatalist, getCountryMaster, fetchProfile } from "./data";
import {
  Saveprofile,
  getMasterDatalist,
  getCountryMaster,
...
function handleClause(
  ...
  // const handlecheckedOther = (row11) => {
  //   console.log(row11);
  ...
  // const handlecheckedOther4 = (row11) => {
  //   console.log(row11);
  ...
  // const handlecheckedother1 = (row11) => {
  //   console.log(row11);
  //   if (row11 === "Marine Specific Voyage Inland") {
  //     return other2;
  //   }
  //   return null;
  // };
  // const handlecheckedother5 = (row11) => {
  //   console.log(row11);
  ...
  // const handleselectallOthers = (e, type, value) => {
  //   // if (type === "Marine Specific Voyage Import") {
  //   //   let iairflag = false;
  //   //   const strArr = value.map((obj) => JSON.stringify(obj));
  //   //   const uniq = [...new Set(strArr)].map((u) => JSON.parse(u));
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother1(ImportRailc);
  //         console.log("push all", other1);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother1(tarr);
  //         console.log("rmove all", other1);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Inland"].Others.CommonClauses = [...other1];
  //   }
  //   //  else if (type === "Marine Specifc Voyage Duty") {
  //   //   let iairflag = false;
  //   //   const strArr = value.map((obj) => JSON.stringify(obj));
  ...
  // const handleselectallOthers4 = (e, type, value) => {
  //   if (type === "Marine Specific Voyage Import") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother4(ImportRailc);
  //         console.log("push all", other4);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother4(tarr);
  //         console.log("rmove all", other4);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Import"].Others.CommonClauses = [...other4];
  //   } else if (type === "Marine Specific Voyage Export") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother5(ImportRailc);
  //         console.log("push all", other5);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother5(tarr);
  //         console.log("rmove all", other5);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.CommonClauses = [...other5];
  //   } else if (type === "Marine Specifc Voyage Duty") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother6(ImportRailc);
  //         console.log("push all", other6);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother6(tarr);
  //         console.log("rmove all", other6);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.CommonClauses = [...other6];
  //   }
  ...
  // const handleselectallOther2 = (e, type, value) => {
  //   if (type === "Marine Specific Voyage Inland") {
  //     let iairflag = false;
  //     const strArr = value.map((obj) => JSON.stringify(obj));
  //     const uniq = [...new Set(strArr)].map((u) => JSON.parse(u));
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother3(ImportRail);
  //         console.log("push all", other3);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother3(tarr);
  //         console.log("rmove all", other3);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Inland"].Others.NonInstituteClauses = [
  //       ...other3,
  //     ];
  //   }
  //   setPolicyDto((prevState) => ({
  ...
  // const handleselectallOther6 = (e, type, value) => {
  //   if (type === "Marine Specific Voyage Import") {
  //     let iairflag = false;
  //     const strArr = value.map((obj) => JSON.stringify(obj));
  //     const uniq = [...new Set(strArr)].map((u) => JSON.parse(u));
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother10(ImportRail);
  //         console.log("push all", other10);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother10(tarr);
  //         console.log("rmove all", other10);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Import"].Others.NonInstituteClauses = [
  //       ...other10,
  //     ];
  //   } else if (type === "Marine Specific Voyage Export") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother11(ImportRail);
  //         console.log("push all", other11);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother11(tarr);
  //         console.log("rmove all", other11);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.NonInstituteClauses = [
  //       ...other11,
  //     ];
  //   } else if (type === "Marine Specifc Voyage Duty") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother12(ImportRail);
  //         console.log("push all", other12);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother12(tarr);
  //         console.log("rmove all", other12);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specifc Voyage Duty"].Others.NonInstituteClauses = [...other12];
  //   }
  ...
  // const handleselectallOthers1 = (e, type, value) => {
  //   if (type === "Marine Specific Voyage Inland") {
  //     let iairflag = false;
  //     const strArr = value.map((obj) => JSON.stringify(obj));
  //     const uniq = [...new Set(strArr)].map((u) => JSON.parse(u));
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother2(InlandAirt);
  //         console.log("push all", other2);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother2(tarr);
  //         console.log("rmove all", other2);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Inland"].Others.InlandTransitClauses = [
  //       ...other2,
  //     ];
  //   }
  ...
  // const handleselectallOthers5 = (e, type, value) => {
  //   if (type === "Marine Specific Voyage Import") {
  //     let iairflag = false;
  //     const strArr = value.map((obj) => JSON.stringify(obj));
  //     const uniq = [...new Set(strArr)].map((u) => JSON.parse(u));
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother7(InlandAirt);
  //         console.log("push all", other7);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother7(tarr);
  //         console.log("rmove all", other7);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Import"].Others.InlandTransitClauses = [
  //       ...other7,
  //     ];
  //   } else if (type === "Marine Specific Voyage Export") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother8(InlandAirt);
  //         console.log("push all", other8);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother8(tarr);
  //         console.log("rmove all", other8);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.InlandTransitClauses = [
  //       ...other8,
  //     ];
  //   } else if (type === "Marine Specifc Voyage Duty") {
  //     let iairflag = false;
  ...
  //     if (iairflag === true) {
  //       if (e.target.checked === true) {
  //         setother9(InlandAirt);
  //         console.log("push all", other9);
  //       } else {
  //         const tarr = [...uniq];
  //         tarr.shift();
  //         setother9(tarr);
  //         console.log("rmove all", other9);
  //       }
  //     } else if (iairflag === false) {
  //       if (e.target.checked === true) {
  //         if (uniq.length === 126) {
  ...
  //       }
  //     }
  //     LPolicyDto.clauses[0]["Marine Specifc Voyage Duty"].Others.InlandTransitClauses = [...other9];
  //   }
  ...
  // const handlecheckedother2 = (row11) => {
  //   console.log(row11);
  //   if (row11 === "Marine Specific Voyage Inland") {
  //     return other3;
  //   }
  ...
  // const handlecheckedother6 = (row11) => {
  //   console.log(row11);
  ...
  // const handelAutoSelectother = (selectedvalue, type) => {
  //   console.log("handelAutoSelectair", selectedvalue, type);
  //   let Autoflag = false;
  //   // if (type === "Marine Specific Voyage Import") {
  //   //   allair15.forEach((x) => {
  ...
  // const handelAutoSelectother4 = (selectedvalue, type) => {
  //   console.log("handelAutoSelectair", selectedvalue, type);
  //   let Autoflag = false;
  //   if (type === "Marine Specific Voyage Import") {
  //     other4.forEach((x) => {
  ...
  // const handelAutoSelectother2 = (selectedvalue, type) => {
  //   console.log("handelAutoSelectair", selectedvalue, type);
  //   let Autoflag = false;
  //   // if (type === "Marine Specific Voyage Import") {
  //   //   allair16.forEach((x) => {
  ...
  // const handelAutoSelectother6 = (selectedvalue, type) => {
  //   console.log("handelAutoSelectair", selectedvalue, type);
  //   let Autoflag = false;
  //   if (type === "Marine Specific Voyage Import") {
  //     other10.forEach((x) => {
  ...
  // const handelAutoSelectother1 = (selectedvalue, type) => {
  //   console.log("handelAutoSelectair", selectedvalue, type);
  //   let Autoflag = false;
  //   // if (type === "Marine Specific Voyage Import") {
  //   //   allair23.forEach((x) => {
  ...
  //   return Autoflag;
  // };
  // const handelAutoSelectother5 = (selectedvalue, type) => {
  //   console.log("handelAutoSelectair", selectedvalue, type);
  //   let Autoflag = false;
  //   if (type === "Marine Specific Voyage Import") {
  //     other7.forEach((x) => {
  ...
  if (
    ...
    if (row2 === "Others") {
      ...
      //           options={ImportRailc}
      //           disableCloseOnSelect
      //           value={handlecheckedOther4(row1)}
      //           // fullWidth
      //           getOptionLabel={(option) => option.mValue}
      //           onChange={(e, value) => handleselectallOthers4(e, row1, value)}
      //           renderOption={(props, option) => (
      //             <li {...props}>
      //               <Checkbox
      //                 icon={icon}
      //                 checkedIcon={checkedIcon}
      //                 style={{ marginRight: 8 }}
      //                 checked={handelAutoSelectother4(option, row1)}
      //               />
      //               {option.mValue}
      //             </li>
      //           )}
      ...
      //           options={InlandAirt}
      //           disableCloseOnSelect
      //           value={handlecheckedother5(row1)}
      //           // fullWidth
      //           getOptionLabel={(option) => option.mValue}
      //           onChange={(e, value) => handleselectallOthers5(e, row1, value)}
      //           renderOption={(props, option) => (
      //             <li {...props}>
      //               <Checkbox
      //                 icon={icon}
      //                 checkedIcon={checkedIcon}
      //                 style={{ marginRight: 8 }}
      //                 checked={handelAutoSelectother5(option, row1)}
      //               />
      //               {option.mValue}
      //             </li>
      //           )}
      ...
      //           options={ImportRail}
      //           disableCloseOnSelect
      //           value={handlecheckedother6(row1)}
      //           // fullWidth
      //           getOptionLabel={(option) => option.mValue}
      //           onChange={(e, value) => handleselectallOther6(e, row1, value)}
      //           renderOption={(props, option) => (
      //             <li {...props}>
      //               <Checkbox
      //                 icon={icon}
      //                 checkedIcon={checkedIcon}
      //                 style={{ marginRight: 8 }}
      //                 checked={handelAutoSelectother6(option, row1)}
      //               />
      //               {option.mValue}
      //             </li>
      //           )}
    ...
    if (row2 === "Others") {
      ...
      //           options={ImportRailc}
      //           disableCloseOnSelect
      //           value={handlecheckedOther(row1)}
      //           // fullWidth
      //           getOptionLabel={(option) => option.mValue}
      //           onChange={(e, value) => handleselectallOthers(e, row1, value)}
      //           renderOption={(props, option) => (
      //             <li {...props}>
      //               <Checkbox
      //                 icon={icon}
      //                 checkedIcon={checkedIcon}
      //                 style={{ marginRight: 8 }}
      //                 checked={handelAutoSelectother(option, row1)}
      //               />
      //               {option.mValue}
      //             </li>
      //           )}
      ...
      //           options={InlandAirt}
      //           disableCloseOnSelect
      //           value={handlecheckedother1(row1)}
      //           // fullWidth
      //           getOptionLabel={(option) => option.mValue}
      //           onChange={(e, value) => handleselectallOthers1(e, row1, value)}
      //           renderOption={(props, option) => (
      //             <li {...props}>
      //               <Checkbox
      //                 icon={icon}
      //                 checkedIcon={checkedIcon}
      //                 style={{ marginRight: 8 }}
      //                 checked={handelAutoSelectother1(option, row1)}
      //               />
      //               {option.mValue}
      //             </li>
      //           )}
      ...
      //           options={ImportRail}
      //           disableCloseOnSelect
      //           value={handlecheckedother2(row1)}
      //           // fullWidth
      //           getOptionLabel={(option) => option.mValue}
      //           onChange={(e, value) => handleselectallOther2(e, row1, value)}
      //           renderOption={(props, option) => (
      //             <li {...props}>
      //               <Checkbox
      //                 icon={icon}
      //                 checkedIcon={checkedIcon}
      //                 style={{ marginRight: 8 }}
      //                 checked={handelAutoSelectother2(option, row1)}
      //               />
      //               {option.mValue}
      //             </li>
      //           )}
...
function ViewDisableProfile() {
  ...
  const [other10, setother10] = useState([]);
  const [other11, setother11] = useState([]);
  const [other12, setother12] = useState([]);
  ...
  const [other9, setother9] = useState([]);
  ...
  // const handleBlur = (e) => {
  //   if (selected2[3].mvalue.length !== 0) {
  //     selected2[3].mvalue.map((qj, j) => {
  //       if (
  //         qj === "Sea" ||
  //         qj === "Rail / Road" ||
  //         qj === "Air" ||
  ...
  //       } else {
  //         console.log(qj, j, selected2, "handleOther1");
  //         selected2[3].mvalue.splice(j, 1);
  //       }
  //       return null;
  //     });
  //   }

  //   if (e.target.name === "Marine Specific Voyage Inland") {
  //     selected2[3].mvalue.push(e.target.value);
  //     setSelected2(selected2);
  //     console.log(selected2, "handleOther");
  //     setPolicyDto(() => ({
  //       ...PolicyDto,
  ...
  // const handleBlur1 = (e) => {
  //   if (selected2[4].mvalue.length !== 0) {
  //     selected2[4].mvalue.map((qj, j) => {
  //       if (
  //         qj === "Sea" ||
  //         qj === "Rail / Road" ||
  //         qj === "Air" ||
  ...
  //       } else {
  //         console.log(qj, j, selected2, "handleOther1");
  //         selected2[4].mvalue.splice(j, 1);
  //       }
  //       return null;
  //     });
  //   }

  //   if (e.target.name === "Marine Specifc Voyage Duty") {
  //     selected2[4].mvalue.push(e.target.value);
  //     setSelected2(selected2);
  //     console.log(selected2, "handleOther");
  //     setPolicyDto(() => ({
  //       ...PolicyDto,
  ...
  // const handleBlur2 = (e) => {
  //   if (selected2[0].mvalue.length !== 0) {
  //     selected2[0].mvalue.map((qj, j) => {
  //       if (
  //         qj === "Sea" ||
  //         qj === "Rail / Road" ||
  //         qj === "Air" ||
  ...
  //       } else {
  //         console.log(qj, j, selected2, "handleOther1");
  //         selected2[0].mvalue.splice(j, 1);
  //       }
  //       return null;
  //     });
  //   }

  //   if (e.target.name === "Marine Specific Voyage Import") {
  //     selected2[0].mvalue.push(e.target.value);
  //     setSelected2(selected2);
  //     console.log(selected2, "handleOther");
  //     setPolicyDto(() => ({
  //       ...PolicyDto,
  ...
  // const handleBlur3 = (e) => {
  //   if (selected2[1].mvalue.length !== 0) {
  //     selected2[1].mvalue.map((qj, j) => {
  //       if (
  //         qj === "Sea" ||
  //         qj === "Rail / Road" ||
  //         qj === "Air" ||
  ...
  //       } else {
  //         console.log(qj, j, selected2, "handleOther1");
  //         selected2[1].mvalue.splice(j, 1);
  //       }
  //       return null;
  //     });
  //   }

  //   if (e.target.name === "Marine Specific Voyage Export") {
  //     selected2[1].mvalue.push(e.target.value);
  //     setSelected2(selected2);
  //     console.log(selected2, "handleOther");
  //     setPolicyDto(() => ({
  //       ...PolicyDto,
  ...
  useEffect(async () => {
    ...
    setImportAir([{ mID: 0, mValue: "Select All" }, ...PortNames.data]);
    setImportAirc([{ mID: 0, mValue: "Select All" }, ...PortNames1.data]);
    setImportSea([{ mID: 0, mValue: "Select All" }, ...PortNames2.data]);
    setImportSeac([{ mID: 0, mValue: "Select All" }, ...PortNames3.data]);
    setImportRail([{ mID: 0, mValue: "Select All" }, ...PortNames4.data]);
    setImportRailc([{ mID: 0, mValue: "Select All" }, ...PortNames5.data]);
    setImportPost([{ mID: 0, mValue: "Select All" }, ...PortNames6.data]);
    setImportPostc([{ mID: 0, mValue: "Select All" }, ...PortNames7.data]);
    setInlandAir([{ mID: 0, mValue: "Select All" }, ...PortNames8.data]);
    setInlandAirc([{ mID: 0, mValue: "Select All" }, ...PortNames9.data]);
    setInlandSea([{ mID: 0, mValue: "Select All" }, ...PortNames10.data]);
    setInlandSeac([{ mID: 0, mValue: "Select All" }, ...PortNames11.data]);
    setInlandAirt([{ mID: 0, mValue: "Select All" }, ...PortNames12.data]);
  ...
  useEffect(() => {
    ...
    // remove commented before phase 2
    // PolicyDto.clauses[0]["Marine Specific Voyage Inland"].Others.CommonClauses = [...other1];
    // PolicyDto.clauses[0]["Marine Specific Voyage Import"].Others.CommonClauses = [...other4];
    // PolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.CommonClauses = [...other5];
    // PolicyDto.clauses[0]["Marine Specifc Voyage Duty"].Others.CommonClauses = [...other6];
    // PolicyDto.clauses[0]["Marine Specific Voyage Inland"].Others.InlandTransitClauses = [...other2];
    // PolicyDto.clauses[0]["Marine Specific Voyage Import"].Others.InlandTransitClauses = [...other7];
    // PolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.InlandTransitClauses = [...other8];
    // PolicyDto.clauses[0]["Marine Specifc Voyage Duty"].Others.InlandTransitClauses = [...other9];
    // PolicyDto.clauses[0]["Marine Specific Voyage Inland"].Others.NonInstituteClauses = [...other3];
    // PolicyDto.clauses[0]["Marine Specific Voyage Import"].Others.NonInstituteClauses = [...other10];
    // PolicyDto.clauses[0]["Marine Specific Voyage Export"].Others.NonInstituteClauses = [...other11];
    // PolicyDto.clauses[0]["Marine Specifc Voyage Duty"].Others.NonInstituteClauses = [...other12];
  });

  // useEffect(() => {
  //   console.log("inpo111111", inpo1, expo1);
  //   console.log(ImportAir, "ImportAirImportAir2");
  //   if (selected3.includes("Other") === false) {
  //     PolicyDto.BOV = "";
  //   }
  // });
  ...
  const listItem2 = options2.map((option) => (
    <Grid sm={12} md={4} lg={4} xl={4} xxl={4} sx={{ fontSize: "15px" }}>
      <div key={option}>
        ...
        <span>{option}</span>
        {/* {option === "Other" && selected3.includes("Other") ? (
          <MDInput
            name="BOV"
            fullwidth
            value={PolicyDto.BOV}
  ...
  useEffect(() => {
    console.log(PolicyDto, "handlepolicydtodisplayed");
  }, [PolicyDto]);

  useEffect(async () => {
    // setid(PolicyDto.UserName);
    Branch.pop();
    setBranch(Branch);
    await fetchuser(`${localStorage.getItem("userId")}`).then(async (result) => {
      const { partnerId } = result.data.userDetails[0];
      await getRequest(`Partner/GetPartnerDetails?partnerId=${partnerId}`).then((res) => {
        console.log("qwertyuiop", res);
        const partnerDetailssss = res.data.partnerDetails;
        console.log("123456789", partnerDetailssss);
        const partnerDetail = JSON.parse(partnerDetailssss);
        Branch.push(partnerDetail.AdditionalDetails.IMDBranchName);
        setBranch(Branch);
  ...
  useEffect(async () => {
    await fetchuser(`${localStorage.getItem("userId")}`).then(async (result1) => {
      if (result1 !== null) {
  ...
  useEffect(async () => {
    Country1.push({ mID: 0, mValue: "Select All" });
    ...
    setCountry([{ mID: 0, mValue: "Select All" }, ...countryMaster.data]);
    console.log(Country, "Country123");
    ...
    // setTypeOfPolicy([...mdatalist.data[65].mdata]);
    // setCargoTypee([{ mID: 0, mValue: "Select All" }, ...mdatalist.data[15].mdata]);

    // setModeOfTransitt([...mdatalist.data[69].mdata]);
    // setBaseofvaluation([...mdatalist.data[8].mdata]);
  ...
  const callSaveprofile = async () => {
    if (
      ...
      await Saveprofile(PolicyDto).then((result) => {
        console.log("111", PolicyDto);
  ...
  useEffect(async () => {
    await fetchuser(`${localStorage.getItem("userId")}`).then(async (result1) => {
      ...
      const UserId1 = new URLSearchParams(search).get("UserName");
      const AgentCode1 = new URLSearchParams(search).get("AgentCode");
      if (result1 !== null) {
        setloadingflag(true);
        await fetchProfile(`${AgentCode1}`, `${UserId1}`).then((result) => {
          ...
          if (result.data.length !== 0) {
            ...
            // setother1([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Inland"].Others.CommonClauses,
            // ]);
            // setother2([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Inland"].Others
            //     .InlandTransitClauses,
            // ]);
            // setother7([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Import"].Others
            //     .InlandTransitClauses,
            // ]);
            // setother8([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Export"].Others
            //     .InlandTransitClauses,
            // ]);
            // setother9([
            //   ...result.data[0].clauses[0]["Marine Specifc Voyage Duty"].Others
            //     .InlandTransitClauses,
            // ]);
            // setother3([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Inland"].Others
            ...
            // ]);
            // setother12([
            //   ...result.data[0].clauses[0]["Marine Specifc Voyage Duty"].Others.NonInstituteClauses,
            // ]);
            // setother4([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Import"].Others.CommonClauses,
            // ]);
            // setother5([
            //   ...result.data[0].clauses[0]["Marine Specific Voyage Export"].Others.CommonClauses,
            // ]);
            // setother6([
            //   ...result.data[0].clauses[0]["Marine Specifc Voyage Duty"].Others.CommonClauses,
            // ]);
            ...
            <Grid container direction="row " ml={-10}>
              <Grid item md={12} lg={12} xl={12} xxl={12} ml={12}>
                                    ...
                                    >
                                      <div key={option}>
                                        <Checkbox
                                          value={option}
                                          onChange={(e, value) =>
                                            handleChange1(e, option, x, value)
                                          }
                ...
                >
                  ...
                  <AccordionDetails>
                    <Grid container spacing={1.5}>
                      ...
                      <Grid item xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                        <MDTypography variant="h6" color="primary">
                          Special Condition,Exclusion and Warranties
                        </MDTypography>
                      </Grid>
                      <Grid item xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                        <MDInput
                ...
                <Grid item xs={12} sm={12} md={4} lg={4} xl={4} xxl={4}>
                  <MDButton alignContent="end" onClick={callSaveprofile}>
                    Create Profile
                  </MDButton>
                </Grid>
              </Grid>
                                ...
                                ? options1.map((option) => (
                                    ...
                                    >
                                      <div key={option}>
                                        ...
                                        <span>{option}</span>
                                        {/* {option === "Others" &&
                                        selected2[3].mvalue.includes("Others") &&
                                        x === "Marine Specific Voyage Inland" ? (
                                          <MDInput
                                            name="Marine Specific Voyage Inland"
                                            fullwidth
                                            // value={PolicyDto.BOV}
                                        ...
                                        {option === "Others" &&
                                        selected2[4].mvalue.includes("Others") &&
                                        x === "Marine Specifc Voyage Duty" ? (
                                          <MDInput
                                            name="Marine Specifc Voyage Duty"
                                            fullwidth
                                            // value={PolicyDto.BOV}
                                            onBlur={handleBlur1}
                                            // error={PolicyDto.UserName === "" ? flag : null}
                                ...
                                : options5.map((option) => (
                                    ...
                                    >
                                      <div key={option}>
                                        ...
                                        <span>{option}</span>
                                        {/* {option === "Others" &&
                                        selected2[0].mvalue.includes("Others") &&
                                        x === "Marine Specific Voyage Import" ? (
                                          <MDInput
                                            name="Marine Specific Voyage Import"
                                            fullwidth
                                            // value={PolicyDto.BOV}
                                            // onChange={handleOther}
                                            onBlur={handleBlur2}
                                        ...
                                        {option === "Others" &&
                                        selected2[1].mvalue.includes("Others") &&
                                        x === "Marine Specific Voyage Export" ? (
                                          <MDInput
                                            name="Marine Specific Voyage Export"
                                            fullwidth
                                            // value={PolicyDto.BOV}
                                            onBlur={handleBlur3}
                                            // error={PolicyDto.UserName === "" ? flag : null}
...
export default ViewDisableProfile;
