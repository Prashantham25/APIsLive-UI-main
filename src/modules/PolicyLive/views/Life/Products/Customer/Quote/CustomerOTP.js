...
import BPFooter from "modules/BrokerPortal/Layouts/BPFooter/index";

import { GetOTP, sendOTP } from "modules/BrokerPortal/Login/BPLogin/data/index";
import { getOTP } from "modules/BrokerPortal/Pages/CustomerEngage/data/index";
import BPNavbarEmpty from "modules/BrokerPortal/Layouts/BPNavbarEmpty/index";

import { useDataController, setCustomerJson } from "../../../../../../BrokerPortal/context";
  ...
  return (
    <PageLayout backgroundColor="#E5E5E5">
      ...
      <Grid container>
        ...
        <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6} mt="8rem">
          <MDBox m={4} ml="10rem">
            <MDTypography variant="h2" sx={{ mt: "1rem" }}>
              Validate OTP
            </MDTypography>
            <MDTypography variant="h5" sx={{ mt: "1rem" }}>
              Enter OTP sent to
            </MDTypography>
            ...
            {/* <MDInput label="OTP" type="text" rows={4} cols={4} /> */}
            <MDTypography variant="body2" sx={{ mt: "1rem" }}>
              <MDTypography
            ...
            {/* <MDTypography variant="body2" sx={{ mt: "1rem" }}>
              <MDTypography sx={{ fontSize: "20px" }}>
                Dont have an account?{" "}
                <Link
                  style={{ color: "#0071D9", cursor: "pointer", marginLeft: "5px" }}
                  to="/modules/BrokerPortal/Pages/CustomerPortal/CustomerSignUp"
                >
                  SignUp
                </Link>
              </MDTypography>
