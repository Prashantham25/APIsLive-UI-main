...
import GoatExcelDownload from "assets/images/Nepal/Goat_LivestockDetails_ExcelUpload.xlsx";
...
import { AgriGoatJson, RiskItems } from "./data/Json/AgriLiveStockJson";
...
const getSectionContent = (activeStep) => {
  ...
  const [flag, setFlag] = useState({
    ...
    backdropflag: false,
    DataGridRegVal: [
      { SumInsured: false, NumberofCattle: false },
      { SumInsured: false, NumberofCattle: false },
      { SumInsured: false, NumberofCattle: false },
      { SumInsured: false, NumberofCattle: false },
    ],
  });
  console.log("DataGridRegVal", flag.DataGridRegVal);
  ...
  const handleDataGridRegVal = (e, index) => {
    flag.DataGridRegVal[index].SumInsured = false;
    flag.DataGridRegVal[index].NumberofCattle = false;
    setFlag({ ...flag });
  };
    ...
    if (key === "BankCategory") {
      if (a !== null) {
        ...
        dto.Bankdetails.BranchDetails.forEach((x, i) => {
          ...
          dto.Bankdetails.BranchDetails[i].Bank = "";
        });
        setGenericPolicyDto(dispatch, dto);
      } else {
  ...
  // };
  const handleDataGrid = (e, param) => {
    // console.log("p", param);
    console.log("param", param);
    const index = param.api.getRowIndex(param.row.rowID);
    ...
    if (e.target.name === "SumInsured") {
      ...
      if (IsNumeric1(e.target.value) === true) {
        flag.DataGridRegVal[index].SumInsured = false;
        setFlag({ ...flag });
        objectPath.set(dto, `Temp.DataGridValues.${index}.SumInsured`, e.target.value);
        objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.SumInsured`, e.target.value);
        if (index === 0) {
          objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.Age`, 90);
        } else if (index === 1) {
          objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.Age`, 155);
        } else if (index === 2) {
          objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.Age`, 1830);
        }
        objectPath.set(
          dto,
          "TotalSumInsured",
          Number(dto.Temp.DataGridValues[0].SumInsured) +
            Number(dto.Temp.DataGridValues[1].SumInsured) +
            Number(dto.Temp.DataGridValues[2].SumInsured)
        );
        objectPath.set(
          dto,
          `Temp.DataGridValues.${3}.SumInsured`,
          formater.format(
            Number(dto.Temp.DataGridValues[0].SumInsured) +
              Number(dto.Temp.DataGridValues[1].SumInsured) +
              Number(dto.Temp.DataGridValues[2].SumInsured)
        ...
        // );
        setGenericPolicyDto(dispatch, dto);
        if (Number(dto.TotalSumInsured) > 50000000) {
          swal.fire({
            icon: "error",
            html: `Maximum Sum Insured limit is 5 Crores`,
            confirmButtonColor: "#0079CE",
          });
          objectPath.set(dto, `Temp.DataGridValues.${index}.SumInsured`, "");
          objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.SumInsured`, "");
          objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.Age`, "");
          objectPath.set(
            dto,
            `Temp.DataGridValues.${3}.SumInsured`,
            formater.format(
        ...
        flag.DataGridRegVal[index].SumInsured = true;
        setFlag({ ...flag });
      }
    }
    if (e.target.name === "NumberofCattle") {
      ...
      if (IsNumeric1(e.target.value) === true) {
        ...
        setFlag({ ...flag });
        // console.log("e.target.value", e.target.value);
        objectPath.set(dto, `Temp.DataGridValues.${index}.NumberofCattle`, e.target.value);
        objectPath.set(dto, `InsurableItem.0.RiskItems.${index}.NumberofCattle`, e.target.value);
        objectPath.set(
          dto,
          `Temp.DataGridValues.${3}.NumberofCattle`,
          (Number(dto.Temp.DataGridValues[0].NumberofCattle) === undefined
            ? 0
            : Number(dto.Temp.DataGridValues[0].NumberofCattle)) +
            (Number(dto.Temp.DataGridValues[1].NumberofCattle) === undefined
              ? 0
              : Number(dto.Temp.DataGridValues[1].NumberofCattle)) +
            (Number(dto.Temp.DataGridValues[2].NumberofCattle) === undefined
              ? 0
              : Number(dto.Temp.DataGridValues[2].NumberofCattle))
        );
        objectPath.set(
          dto,
          "TotalNumberofCattle",
        ...
        flag.DataGridRegVal[index].NumberofCattle = true;
        setFlag({ ...flag });
      }
    }
  };
  const downloadFile = () => {
    ...
    if (objectPath.get(dto, "SubClass") === "Goat") {
      link.download = "Goat_LivestockDetails_ExcelUpload";
      link.href = GoatExcelDownload;
      link.click();
    }
  };
  ...
  const ColumnInfo = {
    ...
    Category: {
      ...
      validationErrMes: () => `(Category Accept only "Goat (Male)" or "Goat (Female)")`,
      ValidationFun: (val) => CategoryValidation(val, ["Goat (Male)", "Goat (Female)"]),
    }, // mandatory
    "Breed/Caste/Variety": {
      mandatory: true,
      mandatoryErrMes: "(Breed/Caste/Variety is Mandatory Field)",
      validationErrMes: () => "(Breed/Caste/Variety Doesn't allow empty space in Starting)",
      ValidationFun: IsFreetextNoSpace,
    }, // mandatory
    "Farming Type": {
      mandatory: true,
      mandatoryErrMes: "(Farming Type is Mandatory Field)",
      validationErrMes: () => "(Farming Type field Doesn't allow empty space in Starting)",
      ValidationFun: IsFreetextNoSpace,
    }, // mandatory
    Color: {
      mandatory: false,
          ...
          if (x.finalResult.FinalPremium !== "") {
            ...
            x.finalResult.NepalAgriCPBGRatingV2.output.forEach((x1, i) => {
              ...
              objectPath.set(
                dto,
                `Temp.Upload.${i}.Rate(%)`,
                (x1.AgriGeneralRateNew * 100).toString().concat("%")
              );
              objectPath.set(dto, `Temp.Upload.${i}.Premium Amount`, x1.BasePremium);
              objectPath.set(
                dto,
                `InsurableItem.0.RiskItems.${i}.Rate(%)`,
                (x1.AgriGeneralRateNew * 100).toString().concat("%")
              );
              objectPath.set(
                dto,
  ...
  const onUploadArr = async (files1) => {
    ...
    fileReader.onload = (e) => {
      ...
      if (res.status === 1) {
        ...
        flag.backdropflag = false;
        setFlag({ ...flag });
        swal.fire({ icon: "error", text: "Invalid Upload", confirmButtonColor: "#0079CE" });
  ...
  const PolicyStartDate = (e, d) => {
    ...
    objectPath.set(
      dto,
      "PolicyEndDate",
      addDays1(objectPath.get(dto, "PolicyStartDate"), dto.NumberofDays)
    );
    setGenericPolicyDto(dispatch, dto);
  };
  useEffect(() => {
  ...
  useEffect(() => {
    if (
      activeStep === 0 &&
      objectPath.get(dto, "Temp.DataGridValues.3.SumInsured") !== undefined &&
      objectPath.get(dto, "Temp.DataGridValues.3.SumInsured") !== "" &&
      objectPath.get(dto, "Temp.DataGridValues.3.NumberofCattle") !== "" &&
      objectPath.get(dto, "Temp.DataGridValues.3.NumberofCattle") !== undefined
    ) {
      objectPath.set(dto, "InsurableItem.0.RiskItems", RiskItems());
      objectPath.set(
        dto,
      ...
      objectPath.set(
        dto,
        "InsurableItem.0.RiskItems.1.NumberofCattle",
        Number(dto.Temp.DataGridValues[1].NumberofCattle)
      );
      objectPath.set(
        dto,
        "InsurableItem.0.RiskItems.2.NumberofCattle",
        Number(dto.Temp.DataGridValues[2].NumberofCattle)
      );
      objectPath.set(
        dto,
      ...
      objectPath.set(
        dto,
        "InsurableItem.0.RiskItems.1.SumInsured",
        Number(dto.Temp.DataGridValues[1].SumInsured)
      );
      objectPath.set(
        dto,
        "InsurableItem.0.RiskItems.2.SumInsured",
        Number(dto.Temp.DataGridValues[2].SumInsured)
      );
      if (
        objectPath.get(dto, "Temp.DataGridValues.0.NumberofCattle") !== "" &&
        objectPath.get(dto, "Temp.DataGridValues.0.NumberofCattle") !== undefined
      ) {
        objectPath.set(dto, "InsurableItem.0.RiskItems.0.Age", 90);
      }
      if (
        objectPath.get(dto, "Temp.DataGridValues.1.NumberofCattle") !== "" &&
        objectPath.get(dto, "Temp.DataGridValues.1.NumberofCattle") !== undefined
      ) {
        objectPath.set(dto, "InsurableItem.0.RiskItems.1.Age", 155);
      }
      if (
        objectPath.get(dto, "Temp.DataGridValues.2.NumberofCattle") !== "" &&
        objectPath.get(dto, "Temp.DataGridValues.2.NumberofCattle") !== undefined
      ) {
        objectPath.set(dto, "InsurableItem.0.RiskItems.2.Age", 1830);
      }
      setGenericPolicyDto(dispatch, dto);
    }
    if (
  ...
  useEffect(async () => {
    ...
    if (QuoteDetails === undefined || QuoteDetails === "") {
      ...
      if (genericInfo.Flow === undefined || genericInfo.Flow === "") {
        ...
        objectPath.set(dto, "Product", "AgriGoat");
      ...
      const TempData = [
        ...
        },
        {
          ...
          NumberofCattle: objectPath.get(dto, "Temp.DataGridValues.1.NumberofCattle"),
          SumInsured: objectPath.get(dto, "Temp.DataGridValues.1.SumInsured"),
          "Premium Amount": objectPath.get(dto, "Temp.DataGridValues.1.Premium Amount"),
          "Rate(%)": objectPath.get(dto, "Temp.DataGridValues.1.Rate(%)"),
          rowID: 2,
        },
        {
          Age: "Above 5 years to 7 years",
          NumberofCattle: objectPath.get(dto, "Temp.DataGridValues.2.NumberofCattle"),
          SumInsured: objectPath.get(dto, "Temp.DataGridValues.2.SumInsured"),
          "Premium Amount": objectPath.get(dto, "Temp.DataGridValues.2.Premium Amount"),
          "Rate(%)": objectPath.get(dto, "Temp.DataGridValues.2.Rate(%)"),
          rowID: 3,
        },
        {
          Age: "Total",
          NumberofCattle: objectPath.get(dto, "Temp.DataGridValues.3.NumberofCattle"),
          SumInsured: objectPath.get(dto, "Temp.DataGridValues.3.SumInsured"),
          "Premium Amount": "",
          "Rate(%)": "",
          rowID: 4,
        },
...

          {
            ...
            columns: [
              ...
              },
              {
                ...
                renderCell: (param) => (
                  <MDInput
                    ...
                    onBlur={(e) => handleDataGridRegVal(e, param.row.rowID - 1)}
                    disabled={param.row.rowID === 4}
                    error={flag.DataGridRegVal[param.row.rowID - 1].SumInsured === true}
                    helperText={
                      flag.DataGridRegVal[param.row.rowID - 1].SumInsured
                        ? "Accept only Numbers greater then Zero"
                        : ""
                    }
                  />
              ...
              },
              {
                ...
                disableColumnMenu: true,
                sortable: false,
                // renderCell: objectPath.get(dto, "Temp.DataGridValues.0.Rate(%)"),
              },
              {
                ...
                disableColumnMenu: true,
                sortable: false,
                // renderCell: objectPath.get(dto, "Temp.DataGridValues.0.Premium Amount"),
              },
            ],
...
const getOnNextClick = async (activeStep, setBackDropFlag) => {
  let fun = false;
  const tDto = { ...topDto };
  if (activeStep === 0 && tDto.InsurableItem[0].RiskItems[1] === undefined) {
    objectPath.set(tDto, "InsurableItem.0.RiskItems.1.NumberofCattle", 0);
    objectPath.set(tDto, "InsurableItem.0.RiskItems.1.SumInsured", 0);
            ...
            async (x) => {
              if (x.finalResult) {
                if (x.finalResult.FinalPremium !== "") {
                  ...
                  // objectPath.set(tDto, "FormatedData.CalculatedPremiumDetails", x.finalResult);
                  setGenericPolicyDto(topDispatch, { ...tDto });
                } else {
                  swal.fire({
                    icon: "error",
      ...
      fun = await GenericApi("NepalAgriLivestock", "NepalAgriLivestockCPBGapi", topDto).then(
        async (x) => {
          if (x.finalResult) {
            ...
            const temp = topDto.Temp.DataGridValues;
            if (temp[0].SumInsured !== "" && temp[0].NumberofCattle !== "") {
              objectPath.set(topDto, "Temp.DataGridValues.0.Rate(%)", "7%");
              objectPath.set(
                topDto,
            ...
            if (temp[1].SumInsured !== "" && temp[1].NumberofCattle !== "") {
              objectPath.set(topDto, "Temp.DataGridValues.1.Rate(%)", "5%");
              objectPath.set(
                topDto,
                `Temp.DataGridValues.1.Premium Amount`,
                formater.format(x.finalResult.NepalAgriCPBGRatingV2.output[1].BasePremium)
              );
            }
            if (temp[2].SumInsured !== "" && temp[2].NumberofCattle !== "") {
              objectPath.set(topDto, "Temp.DataGridValues.2.Rate(%)", "7%");
              objectPath.set(
                topDto,
                `Temp.DataGridValues.2.Premium Amount`,
                formater.format(x.finalResult.NepalAgriCPBGRatingV2.output[2].BasePremium)
              );
            }
            // objectPath.set(
            //   topDto,
