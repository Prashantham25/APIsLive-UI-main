// einubeadmin user login (not a clientfile)
...
import { productList, riskDetails } from "./NBRetail/data/NBTravelJson";
import {
  useDataController,
  setGenericPolicyDto,
  // setGenericInfo,
...
} from "./NBRetail/data/APIs/NBTravelApi";
...
const getSectionContent = (activeStep) => {
  ...
  const CallBenifitdata = async (e, v) => {
    ...
    const disp = objectPath.get(dto, "Display_Name");
    ...
    if (geo === "APAC") objectPath.set(dto, "ProductCode", "AsiaPacific");
      ...
      if (
        disp === "Basic Student Travel - WWIC /WWEU" ||
        disp === "Comprehensive Student Travel -WWIC /WWEU"
      ) {
      ...
      data = [
        ...
        [
          ...
          },
          {
            ...
            label: "Select Address Line 02 as Default Address",
