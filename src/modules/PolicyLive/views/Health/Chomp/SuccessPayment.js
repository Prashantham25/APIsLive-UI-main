...
import { sendPolicyPdf, HandleDownload } from "./data";
        ...
        <Grid container>
                ...
                >
                  ...
                  <Grid item xs={12} sm={12} md={12} lg={12} xl={12} xxl={12}>
                    <MDTypography sx={{ fontSize: "0.8rem", ml: "0rem" }}>
                      Transaction Number :
                      {DentalInsuranceDetails.data.PaymentDetails.PaymentResponse.TransactionNo}
                    </MDTypography>
                  </Grid>
                  ...
                  <Grid container spacing={2} ml={5} mt={2} pb={10}>
                    ...
                    <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
                      <MDTypography sx={{ fontSize: "1rem" }}>
                        {formatter.format(
                          DentalInsuranceDetails.data.PaymentDetails.PaymentResponse.Amount
                        )}
                      </MDTypography>
          ...
          <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
            <Grid container spacing={4} sx={{ mt: "2rem" }}>
              ...
              <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
                <MDTypography variant="h6" sx={{ fontSize: "1.4rem", color: "#000000" }}>
                  {DentalInsuranceDetails.data.ProposerDetails.FirstName} &nbsp;{" "}
                  {DentalInsuranceDetails.data.ProposerDetails.MiddleName} &nbsp;{" "}
                  {DentalInsuranceDetails.data.ProposerDetails.LastName}
                </MDTypography>
              </Grid>
              <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
                <MDTypography sx={{ fontSize: "1rem", color: "#000000" }}>
              ...
              <Grid item xs={12} sm={12} md={6} lg={6} xl={6} xxl={6}>
                <MDTypography variant="h6" sx={{ fontSize: "1.4rem", color: "#000000" }}>
                  {DentalInsuranceDetails.data.TotalMembers}&nbsp;Members
                </MDTypography>
              </Grid>
              <Grid item md={3}>
                <MDButton
              ...
              <Grid item md={3} ml={3}>
                <MDButton
                  display="flex"
                  color="success"
                  onClick={() => HandleDownload(DentalInsuranceDetails.data.PolicyNumber)}
                  // sx={{
                  //   maxHeight: "1.5rem",
                  //   width: "8rem",
                  //   fontSize: "0.5rem",
