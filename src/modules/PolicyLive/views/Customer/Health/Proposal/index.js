...
// import { useDataController, setQuoteProposalOutput } from "../../../../../BrokerPortal/context";
...
function Proposal({ policyDto, setPolicyDto }) {
  return (
    <MDBox>
      {policyDto !== "" && (
        <Card>
          <HorizontalLinearStepper dto={policyDto} setDto={setPolicyDto} />
        </Card>
      )}
    </MDBox>
  );
