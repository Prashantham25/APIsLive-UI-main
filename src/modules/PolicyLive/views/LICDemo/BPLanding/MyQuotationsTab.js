...
const lineOfBusiness = [{ label: "Select" }];
const status = [{ label: "Select" }];
const insurer = [{ label: "Select" }];

function MyQuotationsTab() {
  const rows = [
    {
      quoteNumber: "123456789012",
      createdDate: "20th Jun,2020",
      lineOfBusiness: "Car",
      insurerName: "SBIG",
      premium: "1,350.45",
    ...
    {
      quoteNumber: "102938476573",
      createdDate: "18th Jun,2020",
      lineOfBusiness: "Fire",
  ...
  const handleStatusModal = () => setStatusModal(true);
                ...
                <MDBox display="flex">
                  ...
                  >
                    ...
                    >
                      ...
                      <Grid align="end" mr="1px">
                        <MDButton variant="text">Clear</MDButton>
                        <MDButton onClick={handleCloseStatusModal}>Filter</MDButton>
                      </Grid>
                    </MDBox>
                  </Modal>
                  &nbsp;&nbsp;&nbsp;&nbsp;
                      ...
                      .map((row, i) => (
                        <TableRow keys={i}>
                          ...
                          <TableCell>
                            ...
                            >
                              <MenuItem>View Quote</MenuItem>
                              <MenuItem>Edit Quote</MenuItem>
                              <MenuItem>Deactive Quote</MenuItem>
                              <MenuItem>Share Quote</MenuItem>
                              <MenuItem>Download Quote</MenuItem>
                            </Menu>
                          </TableCell>
                        </TableRow>
                      ))}
...
export default MyQuotationsTab;
