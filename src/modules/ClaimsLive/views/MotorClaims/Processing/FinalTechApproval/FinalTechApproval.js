...
function FinalTechApproval() {
  ...
  const controlItemsLoss = [
    { type: "Input", label: "Loss", visible: true },
    { type: "Input", label: "Expenses", visible: true },
  ];
  return (
...
export default FinalTechApproval;
