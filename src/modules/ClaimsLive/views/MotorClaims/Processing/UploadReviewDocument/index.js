...
import UploadReviewDocumentContent from "./UploadReviewDocumentContent";

function UploadReviewDocument() {
  const AccordionItems = [
    {
      label: "Upload/Review Document",
      content: <UploadReviewDocumentContent />,
      value: 1,
      visible: true,
    },
    {
...
export default UploadReviewDocument;
