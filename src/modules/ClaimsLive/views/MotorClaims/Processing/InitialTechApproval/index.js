...
import InitialTechApproval from "./initialtechapproval";

function InitialTechnicalApproval() {
  const AccordionItems = [
    {
      label: "Initial Technical Approval",
      content: <InitialTechApproval />,
      value: 1,
      visible: true,
    },
  ];
...
export default InitialTechnicalApproval;
