...
function ClaimWithdrow() {
  ...
  const handlesearch = () => {
    setGenericInfo(dispatch, {
      prod: "NepalMotorTwoWheeleClaimWithdrawal",
      claimNo: SearchObj.claimNo,
    });
    // setLoading(false);
    navigate(`/ClaimsLive/ClaimProcessingV2`);
    // claimJson.claimsMenuId = 10;
    ...
    // navigate(`/ClaimsLive/ClaimProcessingV2`, {
    //   state: {
    //     productCode: "NepalMotorTwoWheeleClaimWithdrawal",
    //   },
    // });
  };
