...
function Surveyorfeesettlement() {
  ...
  const handlesearch = () => {
    setGenericInfo(dispatch, {
      prod: "NepalMotorTwoWheeleSurveyorSettlement",
      claimNo: SearchObj.claimNo,
    });
    // setLoading(false);
    navigate(`/ClaimsLive/ClaimProcessingV2`);

    // claimJson.claimsMenuId = 9;
    ...
    // navigate(`/ClaimsLive/ClaimProcessingV2`, {
    //   state: {
    //     productCode: "NepalMotorTwoWheeleSurveyorSettlement",
    //   },
    // });
  };
...
export default Surveyorfeesettlement;
