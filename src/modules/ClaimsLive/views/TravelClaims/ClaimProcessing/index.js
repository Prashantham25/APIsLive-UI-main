...
function ClaimProcessing() {
  ...
  //     setHeaderDetails({
  //       PolicyNumber: TravelClaimJson.policyNo,
  //       ClaimNumber: TravelClaimJson.claimNumber,
  //     });
  // }, []);
        ...
        <Card sx={{ borderRadius: 0 }}>
          <Grid container>
            <Grid item xl={12} md={12} xxl={12}>
              <MDTypography m={2}>
                Policy Number:{TravelClaimJson.policyNo} Claim Number:{TravelClaimJson.claimNumber}
              </MDTypography>
            </Grid>
