...
function ProductClone() {
    ...
    },
    {
      ...
      renderCell: (param) => {
        const handleOpen = async () => {
          ...
          setCloneFlag(dispatch, true);
          const result = await getProductJson(param.row.productId);
          // debugger;
          if (result.data.finalResult !== null) {
            result.data.finalResult.productId = 0;
            result.data.finalResult.productName = "";
            result.data.finalResult.productCode = "";
  ...
  return (
    <Card sx={{ padding: "10px" }}>
      <MDTypography variant="h5">Product Clone</MDTypography>
